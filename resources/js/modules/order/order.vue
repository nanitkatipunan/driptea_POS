      ...
      <div class="row">
        <div class="col-md-4">
          <center>
            ...
            <button
              ...
              :key="index"
              @click="getCupType(item, $event)"
            >{{getCupTypeName(item)}}</button>
          </center>
        </div>
        <div class="col-md-4">
          <center>
        ...
        <div class="col-md-4">
          <center>
            ...
            <button
              class="btn"
              v-for="(item, index) in addOnsData"
              :key="index"
              @click="addAddOns(item, $event)"
            >{{getAddOnsName(item)}}</button>
          </center>
        </div>
      </div>
      <center>
        <button class="btn addCart" @click="addToCart" type="button">Add to Cart</button>
      </center>
    </center>
  </div>
</template>
