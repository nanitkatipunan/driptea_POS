<template>
  <div id="modal" class="blurred-background">
   ...
   <table class="table table-responsive" id="myTable">
                        ...
                        <div style="font-size:12px;" class="mr-3rem" v-for="(items, i) in summary" :key="i">
...
<script>
  export default {
    data() {
      return {
        myTable: [
          { ProductName:'Okinawa', Unit_price: '79',   Qty: '2', Price:'158' },
          { ProductName:'Hokkaido', Unit_price: '79',   Qty: '3', Price:'158' },
          { ProductName:'Pearl Milktea', Unit_price: '79',   Qty: '4', Price:'158' },
          ],
           summary:[
          { Subtotal:'1422', Delivery_Fee: '79',   Total: '9', Incash:'1501', Change:'0' }]
      }
    },
    mounted(){
