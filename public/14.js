...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      //     {
      //       LowDoseQuantity: dataInDB.incomingLowDose
      //     },
      //     { HighDoseQuantity: dataInDB.incomingHighDose }
      //   ],
      dataInDB: []
    };
  },
  ...
  methods: {
    retrieveAllCups: function retrieveAllCups() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].url + "retrieveCupToDisplay").then(function (response) {
        ...
        console.log(_this.dataInDB); // response.data.retrieveups.forEach(element=>{
        //    this.dataInDB.push(item)
        // })
      });
    }
  }
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("v-data-table", {
        attrs: { headers: _vm.headersTop, items: _vm.tableitems },
        scopedSlots: _vm._u([
          {
            key: "items",
            fn: function(props) {
                        ...
                        [
                          {
                            ...
                            fn: function(props) {
                              return [
                                _c("td", [_vm._v(_vm._s(props.item.fname))]),
                                _vm._v(" "),
                                _c("td", [_vm._v(_vm._s(props.item.lname))])
                              ]
                            }
                          }
                        ],
                        ...
                        [
                          {
                            ...
                            fn: function(props) {
                              return [
                                ...
                                _vm._v(" "),
                                _c("td", [_vm._v(_vm._s(props.item.city))])
                              ]
                            }
                          }
                        ],
