...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    retrieveProduct: function retrieveProduct() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_2__["default"].url + "retrieveCustomerOrder", params).then(function (res) {
    ...
    orderNow: function orderNow() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_2__["default"].url + "updateStatus", params).then(function (res) {
