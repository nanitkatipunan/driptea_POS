  ...
  methods: {
    ...
    checkoutMethod: function checkoutMethod() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].url + 'updateStatus', params, _services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].config).then(function (res) {
        ...
        _this4.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].url + 'addCheckout', params, _services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].config).then(function (res) {
          var low = 0;
          var high = 0;
          var over = 0;
          ...
          _this4.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].url + 'updateRemainingCups', param, _services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].config).then(function (response) {
            var parameter = {
              id: res.data.storeCheckouts.id
            };

            _this4.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].url + 'retrieveCheckouts', parameter, _services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].config).then(function (response) {
