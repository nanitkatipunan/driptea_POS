...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    login: function login() {
      Object(json_schema__WEBPACK_IMPORTED_MODULE_3__["validate"])('userName');
      Object(json_schema__WEBPACK_IMPORTED_MODULE_3__["validate"])('password');
      var parameter = {
        name: this.userName,
    ...
    authenticate: function authenticate(name, password) {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + 'login', credentials).then(function (response) {
        ...
        _services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].authenticateForAll('/casherDashboard');
      })["catch"](function (err) {
