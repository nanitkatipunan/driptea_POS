...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'json-schema'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    login: function login() {
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'json-schema'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('userName');
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'json-schema'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('password');
      var parameter = {
        name: this.userName,
