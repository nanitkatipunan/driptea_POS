...
/* harmony import */ var _basic_empty_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../basic/empty.vue */ "./resources/js/basic/empty.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    empty: _basic_empty_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
  ...
  methods: {
    home: function home() {
      _router__WEBPACK_IMPORTED_MODULE_2__["default"].push('/onlineDashboard')["catch"](function () {});
    },
    retrieveProduct: function retrieveProduct() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + 'retrieveCustomerOrder', params).then(function (res) {
    ...
    deleteOrder: function deleteOrder(prodId) {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + 'deleteOrder', {
        id: prodId
      }).then(function (res) {
    ...
    orderNow: function orderNow() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + 'updateStatus', params).then(function (res) {
    ...
    direct: function direct() {
      _router__WEBPACK_IMPORTED_MODULE_2__["default"].push('/orderHistory')["catch"](function () {});
    }
  }
});
