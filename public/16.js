...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    direct: function direct() {
      _router__WEBPACK_IMPORTED_MODULE_2__["default"].push('/customerCart');
    },
    ...
    retrieveCupType: function retrieveCupType() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + "retrieveCupType").then(function (response) {
    ...
    retrieveAddOns: function retrieveAddOns() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + "retrievingAddOns").then(function (response) {
    ...
    retrieveCategory: function retrieveCategory() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + 'retrieveCategoryAscending').then(function (res) {
    ...
    retrieveProduct: function retrieveProduct() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + 'retrieveAllProductAscending').then(function (res) {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                if (_this8.quantity <= 0) {
                  _this8.errorMessage3 = 'quantity must be greater than 0!';
                }

                if (_this8.size === null) {
                  _this8.errorMessage = 'cup size is required!';
                }

                if (_this8.sugarLevel === null) {
                  _this8.errorMessage2 = 'sugar level is required!';
                }

                if (_this8.cupType === null) {
                  _this8.errorMessage1 = 'cup type is required!';
                }

                if (_this8.quantity > 0 && _this8.size !== null && _this8.sugarLevel !== null && _this8.cupType !== null) {
                  if (localStorage.getItem('customerOnlineId') === null) {
                    ...
                    _this8.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + "addCustomer", param).then(function (res) {
                  ...
                  _this8.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_1__["default"].url + 'addOrder', parameter).then(function (response) {
