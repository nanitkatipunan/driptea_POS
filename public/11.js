...
/* harmony import */ var _receipt_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./receipt.js */ "./resources/js/modules/products/receipt.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      cash: null,
      fee: null,
      ReceiptTemplate: _receipt_js__WEBPACK_IMPORTED_MODULE_2__["default"]
    };
  },
  mounted: function mounted() {
    this.retrieveCategory();
    this.retrieveProduct();
    var vfs = pdfmake_build_vfs_fonts_js__WEBPACK_IMPORTED_MODULE_3___default.a.pdfMake.vfs;
    _receipt_js__WEBPACK_IMPORTED_MODULE_2__["default"].vfs = vfs;
  },
  methods: {
    ...
    checkoutOrder: function checkoutOrder() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].url + 'updateStatus', params).then(function (res) {
        ...
        _this4.ReceiptTemplate.template(); // localStorage.removeItem('customerId')
...
/***/ "./resources/js/modules/products/receipt.js":
/*!**************************************************!*\
  !*** ./resources/js/modules/products/receipt.js ***!
  \**************************************************/
/*! exports provided: default */
...
throw new Error("Module build failed (from ./node_modules/babel-loader/lib/index.js):\nError: ENOENT: no such file or directory, open 'C:\\capstone\\driptea_POS\\resources\\js\\modules\\products\\receipt.js'");
