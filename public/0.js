...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    retrievePending: function retrievePending() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].url + 'retrieveOnlineOrders', parameter).then(function (response) {
        ...
        console.log('This', _this2.tableDataPending);
      });
    },
